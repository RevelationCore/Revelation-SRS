...
export const PUBLISHED_EVENTS: EventDef[] = [
  ...
  {
    typeName: 'EngagementInterventionOpenedV1Payload',
    file: 'engagement/intervention-opened.v1.ts',
    subject: 'srs.engagement.intervention.opened',
    schemaPath: 'engagement/intervention-opened',
    dataClass: 'sensitive',
    partitionKey: 'personId',
    consumers: ['engagement-service', 'personal-tutor-portal'],
  },
  {
    typeName: 'EngagementInterventionReviewedV1Payload',
    file: 'engagement/intervention-reviewed.v1.ts',
    subject: 'srs.engagement.intervention.reviewed',
    schemaPath: 'engagement/intervention-reviewed',
    dataClass: 'sensitive',
    partitionKey: 'personId',
    consumers: ['engagement-service'],
  },
  {
    typeName: 'EngagementReferralCreatedV1Payload',
    file: 'engagement/referral-created.v1.ts',
    subject: 'srs.engagement.referral.created',
    schemaPath: 'engagement/referral-created',
    dataClass: 'sensitive',
    partitionKey: 'personId',
    consumers: ['wellbeing-module', 'sponsor-compliance-service'],
  },
  {
    typeName: 'EngagementInterventionClosedV1Payload',
    file: 'engagement/intervention-closed.v1.ts',
    subject: 'srs.engagement.intervention.closed',
    schemaPath: 'engagement/intervention-closed',
    dataClass: 'sensitive',
    partitionKey: 'personId',
