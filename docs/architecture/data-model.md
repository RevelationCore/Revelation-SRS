...
> Business-process review: BPR-D01–BPR-D19 have been assessed in the [data-model delta](business-process-data-model-delta.md), with a [target model](business-process-target-data-model.md) and [migration plan](business-process-data-migration-plan.md). Their governing ADRs (016–022) are all accepted as of 2026-08-03; see [current-capabilities.md](../product/current-capabilities.md) for implementation status per capability.
