...
| Data entities | Clearing contact, permission, choice and confirmed place; supporting identity, evidence, decision and integration-exchange records |
| Domain events | Proposed: `srs.place.an.applicant.through.clearing.completed` |
| Integration contracts | SRS ↔ UCAS; SRS ↔ curriculum/capacity |
...
**Starts when:** An eligible applicant seeks a place on a course with a declared vacancy.
...
| Clearing Adviser | Provides evidence, decision, system processing or governed support |
| Admissions Officer | Provides evidence, decision, system processing or governed support |
| UCAS | Provides evidence, decision, system processing or governed support |
...
An eligible applicant seeks a place on a course with a declared vacancy.
...
5. **Clearing Adviser** receive and match the formal UCAS choice.
6. **Admissions Officer** make and return the confirmation decision, then reconcile the place and vacancy.

## Alternative flows

### A1 — Variant

- **A1.1** Direct-to-Clearing applicants complete and submit a UCAS application before adding the choice.

### A2 — Variant

- **A2.1** A changed-course proposition records explicit consent.

## Exception flows

### E1 — Control exception

- **E1.1** A verbal indication is not a confirmed place.

### E2 — Control exception

- **E2.1** Expired permission, missing choice or exhausted capacity returns to review without oversubscription.

## Postconditions

### Successful

- The Clearing contact, permission, choice and confirmed place is authoritative, effective-dated and linked to its evidence and decision authority.
...
|---|---|---|---|---|
| BR-1 | SECTOR | Apply the current authoritative requirement and provider regulation for the person, level, mode and nation | UK/configured | SRC-051–SRC-052 |
| BR-2 | INSTITUTION | Decision roles, deadlines, evidence and permitted discretion are policy-versioned | Provider | Provider regulations |
| BR-3 | REVELATION | No durable provisional-permission/capacity reservation and UCAS reconciliation workflow exists. | Revelation | SRC-015–SRC-019 |
...
|---|---|---|---|---|
| Clearing contact, permission, choice and confirmed place | Create/version | SRS or governed specialist source | Policy, actor, evidence, decision and effective/transaction times | Personal; may be sensitive |
...
|---|---|---|---|---|
| SRS ↔ UCAS | Connected system | application, choice and decision | Versioned/idempotent contract | Retry, quarantine, acknowledge and reconcile |
| SRS ↔ curriculum/capacity | Connected system | vacancy | Versioned/idempotent contract | Retry, quarantine, acknowledge and reconcile |
...
|---|---|
| [SRC-051–SRC-052](../source-register.md) | External process, regulatory or sector evidence |
