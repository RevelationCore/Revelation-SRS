...
| Data entities | Northern Ireland return/extract and sign-off; supporting identity, evidence, decision and integration-exchange records |
| Domain events | Proposed: `srs.produce.department.for.the.economy.returns.completed` |
| Integration contracts | SRS/HESA snapshot → DfE |
...
**Starts when:** A Department for the Economy data or funding requirement is due.
...
|---|---|
| DfE Returns Officer | Initiates or owns the principal business action |
...
| Department for the Economy | Provides evidence, decision, system processing or governed support |

**Accountable owner:** DfE Returns Officer service owner or delegated authority (TBC)
...
A Department for the Economy data or funding requirement is due.
...
- **A1.1** University and FE-delivered HE requirements remain distinct.

### A2 — Variant

- **A2.1** Statistical outputs derived from HESA reconcile to the accepted HESA submission.

## Exception flows

### E1 — Control exception

- **E1.1** Unclear scope or conflicting definition is escalated.

### E2 — Control exception

- **E2.1** Rejected data follows governed correction/resubmission.

## Postconditions

### Successful

- The Northern Ireland return/extract and sign-off is authoritative, effective-dated and linked to its evidence and decision authority.
...
|---|---|---|---|---|
| BR-1 | SECTOR | Apply the current authoritative requirement and provider regulation for the person, level, mode and nation | UK/configured | SRC-069 |
| BR-2 | INSTITUTION | Decision roles, deadlines, evidence and permitted discretion are policy-versioned | Provider | Provider regulations |
| BR-3 | REVELATION | No DfE-specific contract, definition catalogue or sign-off workflow exists. | Revelation | SRC-015–SRC-019 |
...
|---|---|---|---|---|
| Northern Ireland return/extract and sign-off | Create/version | SRS or governed specialist source | Policy, actor, evidence, decision and effective/transaction times | Personal; may be sensitive |
...
|---|---|---|---|---|
| SRS/HESA snapshot | DfE | return/extract | Versioned/idempotent contract | Retry, quarantine, acknowledge and reconcile |

## Sequence diagram

```mermaid
sequenceDiagram
    actor A1 as DfE Returns Officer
...
|---|---|
| [SRC-069](../source-register.md) | External process, regulatory or sector evidence |
